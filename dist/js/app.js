...
},{"b55mWE":1}],5:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-db5d5682", module.exports)
  } else {
    hotAPI.update("_v-db5d5682", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	...
	methods: {
		...
		dropItem: function dropItem() {
			if (confirm("子項目會跟著刪除，真的要刪？")) this.$parent.item.child.$remove(this.item);
		},
		createItem: function createItem() {
			// debugger;
			if (!this.item.child) this.item.child = new Array();
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2331d0ba", module.exports)
  } else {
    hotAPI.update("_v-2331d0ba", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/Child.vue":6,"jquery":2,"vue":4,"vue-hot-reload-api":3}],7:[function(require,module,exports){
"use strict";
...
var items = [{ name: "List item" }, { name: "List item" }, { name: "List item" }];
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-75da5720", module.exports)
  } else {
    hotAPI.update("_v-75da5720", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7105d120", module.exports)
  } else {
