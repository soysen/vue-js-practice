...
},{"b55mWE":39}],43:[function(require,module,exports){
"use strict";
...
exports.default = {
    ...
    methods: {
        delTodo: function delTodo(item, list) {
            list.$remove(item);
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-27a27818", module.exports)
  } else {
    hotAPI.update("_v-27a27818", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/TodoEditor.vue":44,"babel-runtime/core-js/get-iterator":1,"vue":42,"vue-hot-reload-api":40}],44:[function(require,module,exports){
"use strict";
...
exports.default = {
    ...
    methods: {
        ...
        deleteTodo: function deleteTodo(item, list) {
            list.$remove(item);
        },
